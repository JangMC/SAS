...
ods graphics on;
title 'Principal Factor Analysis without factor rotation';
...
ods graphics on;
title 'Principal Factor Analysis with VARIMAX rotation';
...
ods graphics on;
title 'Maximum Likelihood Factor analysis with VARIMAX rotation';
...
ods graphics on;
title 'Maximum Likelihood Factor analysis with VARIMAX rotation with MAX argument';
